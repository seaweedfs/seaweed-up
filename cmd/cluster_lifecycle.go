...
func addLifecycleFlags(cmd *cobra.Command, opts *ClusterLifecycleOptions) {
	...
	cmd.Flags().StringVarP(&opts.Component, "component", "c", "", "specific component to target [master|volume|filer]")
...
func runClusterLifecycle(verb manager.LifecycleVerb, opts *ClusterLifecycleOptions) error {
	...
	case "", "master", "volume", "filer":
	default:
		return fmt.Errorf("invalid --component value %q (want master|volume|filer)", opts.Component)
	}
