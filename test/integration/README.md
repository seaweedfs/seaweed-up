...
|--------|---------------|-----------------------------------|
| host1  | 10.200.41.10   | Master, Filer (single-node tests) |
| host2  | 10.200.41.11   | Volume server                     |
| host3  | 10.200.41.12   | Volume server                     |
...
2. **Network**: Containers use a custom bridge network (10.200.41.0/24). This may conflict with existing Docker networks.
