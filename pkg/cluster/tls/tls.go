...
// plus the shared ca.crt when withTLS is true.
//
...
func RenderSecurityTOML(component, jwtFilerWriteKey, jwtFilerReadKey string, withTLS bool) string {
	if component == "" {
		component = "all"
	}
	var b strings.Builder
	fmt.Fprintf(&b, `# security.toml generated by seaweed-up for component: %s
...
key = %q
`, component, jwtFilerWriteKey, jwtFilerReadKey)
